    ...
    <AppLayout title="Create Product">
        <div class="flex flex-col min-h-screen items-center p-10">
            ...
            <form @submit.prevent="submit" class="w-full max-w-lg">
                ...
                <Link :href="route('client.products.index')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                    Back
                </Link>
