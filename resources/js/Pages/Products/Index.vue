<template>
    <AppLayout title="Products">
        ...
        <div class="flex flex-grow min-h-screen overflow-hidden">
            <!-- Sidebar for Filters -->
            <aside class="w-1/5 p-4 bg-purple-300 rounded-lg shadow-md overflow-y-auto">
                <div class="mb-4">
            ...
            <main class="w-4/5 p-2 bg-indigo-200 overflow-auto">
                <div class="flex flex-wrap justify-around gap-4">
                    <div
                        v-for="(product, index) in props.products.data.slice(0, 12)"
                        :key="product.id"
                        class="bg-purple-100 border rounded-lg shadow-md w-full sm:w-1/2 md:w-1/4 lg:w-1/5 p-5"
                    >
                        <a href="#">
                            <img class="rounded-t-lg w-full h-48 object-cover" :src="product.image" alt="Product Image" />
                        </a>
                        <div class="mt-4">
                            <a href="#">
                        ...
                        <Link :href="route('products.show', product.id)" class="inline-flex items-center mt-3 px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Read more
                ...
                <Pagination :meta="props.products.meta" @pagination-change-page="onSearchProducts" class="mt-4" />
            </main>
        </div>
    </AppLayout>
</template>
