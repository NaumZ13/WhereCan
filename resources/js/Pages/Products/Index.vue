                ...
                <div class="mb-4">
                    ...
                    <div>
                        <label class="inline-flex items-center">
                            ...
                            <span class="ml-2 text-gray-900 dark:text-white">In Stock</span>
                        </label>
                    </div>
                    <div>
                        <label class="inline-flex items-center">
                            <input type="checkbox" class="form-checkbox text-blue-600 dark:text-blue-400" />
                            <span class="ml-2 text-gray-900 dark:text-white">On Sale</span>
                        </label>
                    </div>
                </div>
            </aside>
                        ...
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-full">
                            ...
                            <div class="p-5 flex flex-col justify-between h-full">
                                ...
                                <div class="mt-auto h-full">
                                    <Link :href="route('products.show', product.id)"  class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        Read more
