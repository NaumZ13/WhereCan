...
use App\Http\Controllers\Clients\RegisteredClientController;
    ...
    if (Features::enabled(Features::registration())) {
        if ($enableViews) {
            Route::get(RoutePath::for('register', '/register'), [RegisteredUserController::class, 'create'])
                ->middleware(['guest:'.config('fortify.guard')])
                ->name('register');
            Route::get(RoutePath::for('client.register', '/client/register'), [RegisteredClientController::class, 'create'])
                ->middleware(['guest:'.config('fortify.guard')])
        ...
        Route::post(RoutePath::for('register', '/register'), [RegisteredUserController::class, 'store'])
            ->middleware(['guest:'.config('fortify.guard')]);
        Route::post(RoutePath::for('client.register', '/client/register'), [RegisteredClientController::class, 'store'])
            ->middleware(['guest:'.config('fortify.guard')]);
    }
